...
export function CreateEntityDialog({ entityType, visible, organizationId, scope, onCreated, onHide }: CreateEntityDialogProps) {
  ...
  return (
    ...
    >
      ...
      {visible && config.list.createForm({ organizationId, scope, onCreated, onCancel: onHide })}
    </Dialog>
  );
}
