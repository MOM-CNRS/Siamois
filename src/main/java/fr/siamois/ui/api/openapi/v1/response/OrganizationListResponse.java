...
public class OrganizationListResponse extends ListResponse<OrganizationResource> {
    public OrganizationListResponse(List<OrganizationResource> data, ListMeta meta) {
        super(data, meta);
    }
}
